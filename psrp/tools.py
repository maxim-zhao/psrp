...
class ScriptEntry:
    ...
    def parse_tag(self, match, s):
        ...
        # TODO: extract these from the tbl?
            ...
            self.buffer.append(4)
            pass
        elif tag == "he" or tag == "she" or tag == "Sie" or tag == "Er" or tag == "ela" or tag == "ell" or tag == "ella" or tag == "él":
            # Pronoun
            self.buffer.append(ScriptingCode.SymbolPronoun)
            self.buffer.append(0)
            self.script_hints = True
            pass
        elif tag == "his" or tag == "her" or tag == "sie" or tag == "er" or tag == "el seu" or tag == "la seva" or tag == "su":
