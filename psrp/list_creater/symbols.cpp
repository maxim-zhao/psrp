        ...
        do
        {
            ...
            else
            {
                ...
                case 0xc9: fprintf(out, "<line>");
                    break;
                case 0xcc: fprintf(out, "<number>");
                    break;
                case 0xcd: fprintf(out, "<name>");
                    break;
                case 0xd1: fprintf(out, "<item>");
                    break;
                case 0xd2: fprintf(out, "<spell>");
                    break;
                case 0xd4: fprintf(out, "<blink pause>");
                    break;
                case 0xd6: fprintf(out, "<0.5-sec delay>");
                    break;
                case 0xd7: fprintf(out, "<pause>");
                    break;
                case 0xd8: fprintf(out, "<1.5-sec delay>");
                    break;
                case 0xda: Lookup(0x7edd0 - 0x7c000, out);
                    break;
                case 0xdb: fprintf(out, "<end>");
                    break;
                default:
